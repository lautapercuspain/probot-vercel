...
export async function handlePullRequestOpened({ context, payload, octokit, openai }) {
  ...
  //       role: 'user',
  //       content: `
  //           Create at least one unit test, using the following libs: ${depList}, for the following code: function Greetings(name){ return 'Hi $name'}.
  ...
  // const completion: OpenAI.Chat.ChatCompletion = await openai.chat.completions.create(pay)
  // await context.octokit.repos.createOrUpdateFileContents({
  //   repo,
  //   owner,
  //   path: 'pages/components/testing-example.test.js', // the path to your config file
  //   message: `Add test for example.test.`,
